...
- `governance/decisions/architecture.md (D-3)` — the cache (`index.db`) vs user-authored state (`pql.db`) split. Read before touching anything that persists under `.pql/`.
